...
(function() {
  ...
  Message = (function() {
    ...
    Message.prototype.sendMessage = function() {
      return this.submit.keydown(event, function() {
        if (event.keyCode === 13) {
    ...
    Message.prototype.controllerCheck = function() {
      return window.location.pathname === "/purchases/new";
    };
...
(function() {
  var Item, Message, Product, Purchase,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
        ...
        return function() {
          ...
          return $.ajax({
            ...
            error: function(data, textStatus, errorThrown) {
              ...
              return new Message(messages, css, false);
            },
  ...
  Message = (function() {
    function Message(errors, css, alert1) {
      this.errors = errors;
      this.alert = alert1;
    ...
    Message.prototype.renderAlert = function() {
      return alert(this.errors.toString());
    };

    Message.prototype.renderErrors = function() {
      var message;
    ...
    Message.prototype.authenticationError = function(message) {
      return this.errors[message] = "You need to log in to perform this action";
    };

    Message.prototype.renderMessage = function(message) {
  ...
  Product = (function() {
    ...
    Product.host = "https://s3.eu-central-1.amazonaws.com/sprachspiel/";

    Product.numbers = ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"];

    function Product(product) {
      this.setEvent = bind(this.setEvent, this);
      var data_name, index, j;
    ...
    Product.prototype.changeIcon = function() {
      var newlink;
      newlink = Product.host + this.sequence[this.amount] + ".svg";
      this.icon.attr("src", newlink);
