...
(function() {
  App.cable.subscriptions.create({
    ...
    renderMessage: function(data) {
      return "<p class=\"message " + data.alignment + "\">" + data.user + ": " + data.message + "</p>";
    }
  });
...
(function() {
  ...
  $(document).on('turbolinks:load', function() {
    return $('[data-id="chatroom-input"]').keydown(function(event) {
      if (event.key === "Enter") {
        $('[data-send="message"]').click();
        return $('[data-textarea="message"]').val(" ");
      }
    });
  });
  ...
  this.Message = (function() {
    function Message(data) {
      ...
      this.submit = $('[data-id="chatroom-input"]');
    ...
    Message.prototype.sendMessage = function() {
      return this.submit.keydown(function(event) {
        if (event.key === "Enter") {
          $('[data-send="message"]').click();
    ...
    Message.prototype.scrollDownChat = function() {
      var height;
      height = this.scrollbar[0].scrollHeight;
      return this.scrollbar.scrollTop(height);
    };
