...
(function() {
  ...
  Purchase = (function() {
    function Purchase() {
      this.submit = $('#submit');
      this.products = $.map($('.product-partial'), function(product, i) {
  ...
  Product = (function() {
    function Product(product) {
      ...
      this.icon = this.product.find('img[data-name=icon]');
      this.setEvent();
    ...
    Product.prototype.host = "https://s3.eu-central-1.amazonaws.com/sprachspiel/";

    Product.prototype.numbers = ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"];

    Product.prototype.sequence = {};

    Product.prototype.setEvent = function() {
      return this.product.click((function(_this) {
        return function() {
          _this.increaseItemCount();
          return _this.changeIcon();
        };
      })(this));
    };
    ...
    Product.prototype.setHash = function(index) {
      return this.sequence[index + 1] = this.numbers[index];
    };

    Product.prototype.changeIcon = function() {
      var newlink;
      newlink = this.host + this.sequence[this.amount] + ".svg";
